...
```javascript
httpServer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/net-disposable-http-server@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/net-disposable-http-server@umd/bundle.js"></script>
```
